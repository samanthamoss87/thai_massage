...
class BookingForm(forms.ModelForm):
    ...
    duration = forms.ChoiceField(choices=DURATION_CHOICES, required=True, label="Session Duration")
    class Meta:
        model = Booking
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['duration'].widget = forms.Select(choices=[(30, '30 minutes'), (60, '1 hour'), (120, '2 hours')])