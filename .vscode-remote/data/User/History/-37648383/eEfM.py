...
class Booking(models.Model):
    ...
    def get_duration_minutes(self):
        ...
        if self.treatments.half_hour:
            return 30
        elif self.treatments.one_hour:
            return 60
        elif self.treatments.two_hour:
            return 120
        return 0

    def __str__(self):
        return f"{self.user.username} - {self.treatments.name} on {self.date} at {self.start_time}"