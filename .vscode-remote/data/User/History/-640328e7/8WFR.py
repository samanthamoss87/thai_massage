...
def book_now(request):
    ...
    booked_slots = Booking.objects.filter(date=request.POST.get('date')).values('time', 'duration')
    unavailable_times = []
    ...
    return render(request, 'booking.html', {'form': form, 'unavailable_times': unavailable_times})
