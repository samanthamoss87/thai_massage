...
class AuthTests(TestCase):
    def setUp(self):
        ...
        UserProfile.objects.create(user=self.user, mobile='1234567890')
        self.client = Client()
    ...
    def test_user_registration(self):
        ...
        self.assertRedirects(response, reverse('home'))  # Check redirect to home page
        ...
        self.assertEqual(user_profile.mobile, '0987654321')
    ...
    def test_access_dashboard_authenticated(self):
        ...
        response = self.client.get(reverse('dashboard'))
        self.assertEqual(response.status_code, 200)  # Check that the dashboard is accessible
        self.assertContains(response, 'Welcome, Test!')  # Check for welcome message
